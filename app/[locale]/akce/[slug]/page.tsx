    ...
    <div className="-mt-28 md:-mt-32">
      <PageHero
        ...
        topContent={
          <Link
            href="/akce"
            className="inline-flex min-h-10 items-center justify-center font-sans text-[0.68rem] uppercase tracking-[0.18em] text-[rgba(231,238,232,0.9)] transition duration-200 hover:translate-x-[0.5%]"
          >

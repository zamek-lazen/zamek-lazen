              ...
              >
                ...
                >
                  <div className='p-7 md:p-10'>
                    <p className='font-sans text-[0.68rem] tracking-[0.22em] text-[rgba(191,211,201,0.56)] uppercase'>
                      {t('upcomingLabel')}
                    </p>
                    <p className='mt-4 font-sans text-[0.82rem] tracking-[0.18em] text-[rgba(220,230,224,0.7)] uppercase'>
                    ...
                    <p className='mt-6 max-w-[60ch] font-sans text-[1rem] leading-[1.9] whitespace-pre-line text-[rgba(203,218,209,0.78)]'>
                      {featuredEvent.description}
                    </p>
                    <span className='mt-8 inline-flex min-h-11 items-center justify-center border border-[rgba(193,215,204,0.28)] px-6 py-3 font-sans text-[0.75rem] tracking-[0.18em] text-[rgba(231,238,232,0.94)] uppercase transition-colors duration-200 group-hover:border-[rgba(223,234,226,0.52)]'>
                      {t('detailCta')}
                    </span>
                  </div>
                ...
                <div className='grid gap-5 lg:grid-cols-2'>
                  {otherEvents.map((event) => (
                    ...
                    >
                      ...
                      <div className='p-7'>
                        <p className='font-sans text-[0.74rem] tracking-[0.18em] text-[rgba(214,225,217,0.62)] uppercase'>
                          {formatEventDate(event.date, locale)}
                        </p>
                        <h3 className='mt-4 font-serif text-[clamp(1.8rem,2.8vw,2.5rem)] leading-[1.02] text-[rgba(241,245,239,0.94)]'>
                          {event.title}
                        </h3>
                        <p className='mt-5 font-sans text-[0.98rem] leading-[1.85] whitespace-pre-line text-[rgba(196,211,202,0.76)]'>
                          {event.description}
                        </p>
                        <span className='mt-6 inline-flex min-h-11 items-center justify-center border border-[rgba(193,215,204,0.24)] px-5 py-3 font-sans text-[0.72rem] tracking-[0.18em] text-[rgba(231,238,232,0.9)] uppercase transition-colors duration-200 group-hover:border-[rgba(223,234,226,0.48)]'>
                          {t('detailCta')}
                        </span>
                      </div>
                    </Link>

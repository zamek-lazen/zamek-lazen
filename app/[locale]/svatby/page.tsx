...
export default async function WeddingsPage({ params }: WeddingsPageProps) {
  const { locale } = await params
  ...
  return (
    <>
      ...
      <div className='-mt-28 md:-mt-32'>
        ...
        <RevealOnScroll
          as='section'
          className='editorial-surface-dark border-t border-[rgba(185,212,197,0.08)] px-[1.2rem] py-10 md:px-8'
        >
        ...
        >
          <div className='mx-auto w-full max-w-376'>
            <div className='max-w-160rem mx-auto text-center lg:mx-0 lg:text-left'>
              <p className='editorial-eyebrow editorial-eyebrow-dark'>
                {t('finalEyebrow')}
              </p>
              ...
              <p className='editorial-lead editorial-lead-dark mx-auto mt-6 lg:mx-0'>
                {t('finalBody')}
              </p>
            </div>

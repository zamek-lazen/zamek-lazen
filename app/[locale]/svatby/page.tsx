      ...
      <section className="bg-[linear-gradient(180deg,rgba(8,27,22,1),rgba(6,22,17,1))] px-[1.2rem] py-[clamp(4rem,8vw,7rem)] text-[var(--color-mist-100)] md:px-8">
        <div className="mx-auto grid w-full max-w-[94rem] gap-10 lg:grid-cols-[minmax(0,0.84fr)_minmax(0,1.16fr)] lg:items-start">
          <div className="max-w-[35rem]">
            <p className="font-sans text-[0.72rem] uppercase tracking-[0.22em] text-[rgba(184,201,191,0.58)]">
              {t("processEyebrow")}
            </p>
          ...
          <div className="grid gap-4">
            {steps.map((step, index) => (
              ...
              >
                <span className="font-sans text-[0.72rem] uppercase tracking-[0.22em] text-[rgba(184,201,191,0.56)]">
        ...
        <div className="mx-auto grid w-full max-w-[94rem] gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
          ...
          <div className="grid gap-4">
            {contacts.map((contact) => (
              ...
              >
                <p className="font-sans text-[0.68rem] uppercase tracking-[0.2em] text-[rgba(184,201,191,0.62)]">
                  {contact.label}
                </p>
                <p className="mt-3 break-words font-serif text-[clamp(1.55rem,2.8vw,2.25rem)] leading-[1.08] text-[rgba(241,245,239,0.97)]">
                  {contact.value}
                </p>
                <span className="mt-6 inline-flex border-b border-[rgba(221,231,223,0.32)] pb-1 font-sans text-[0.75rem] uppercase tracking-[0.16em] text-[rgba(229,236,230,0.82)]">
                  {contact.action}
                </span>
              </a>
            ))}

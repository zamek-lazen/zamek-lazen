        ...
        <div className="grid gap-4 md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-[1rem] border border-[rgba(19,52,45,0.08)] bg-[rgba(255,255,255,0.48)] p-6 shadow-[0_20px_60px_rgba(15,33,28,0.08)]">
              <p className="font-sans text-[0.72rem] uppercase tracking-[0.2em] text-[rgba(19,52,45,0.48)]">
                1728 / 12 ha / 2009
              </p>
              <p className="mt-4 font-serif text-[1.55rem] leading-[1.2] text-[rgba(19,52,45,0.92)]">
                Krajina, architektura a klid tvoří charakter místa stejně silně jako samotná budova.
              </p>
            </div>
          </div>
        </div>

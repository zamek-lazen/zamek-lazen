      ...
      <div className="mx-auto w-full max-w-[94rem]">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.74fr)_minmax(0,1.26fr)] lg:items-start">
          <div className="max-w-[34rem]">
            ...
            <Link
              href="/akce"
              className="mt-8 inline-flex min-h-11 items-center justify-center border border-[rgba(193,215,204,0.28)] px-6 py-3 font-sans text-[0.75rem] uppercase tracking-[0.18em] text-[rgba(231,238,232,0.94)] transition-colors duration-200 hover:border-[rgba(223,234,226,0.52)]"
            >
              {cta}
            </Link>
          </div>
          ...
          <div className="border-t border-[rgba(185,212,197,0.18)] pt-5">
            {featuredEvent ? (
              <div className="grid">
                ...
                >
                  <div>
                    <p className="font-sans text-[0.68rem] uppercase tracking-[0.22em] text-[rgba(191,211,201,0.54)] transition-colors duration-200 group-hover:text-[rgba(221,233,223,0.76)]">
                      {featuredLabel}
                    </p>
                    <p className="mt-4 font-sans text-[0.78rem] uppercase tracking-[0.18em] text-[rgba(220,230,224,0.72)] transition-colors duration-200 group-hover:text-[rgba(236,241,236,0.86)]">
                      {featuredEvent.label}
                    </p>
                  </div>
                ...
                {remainingEvents.length > 0 ? (
                  <div className="grid">
                    {remainingEvents.map((event, index) => (
                      ...
                      >
                        <span className="font-sans text-[0.72rem] uppercase tracking-[0.18em] text-[rgba(220,230,224,0.68)]">
                          {event.label}
                        </span>

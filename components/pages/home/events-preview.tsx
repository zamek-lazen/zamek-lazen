          ...
          <RevealStagger className='mt-10 grid gap-4 md:grid-cols-3'>
            {events.map((event, index) => (
              <Link
                ...
                href={event.href}
                className='group block h-full w-full rounded-2xl border border-[rgba(254,252,232,0.14)] bg-(--color-forest-900) p-6 shadow-[0_18px_48px_rgba(0,0,0,0.18)] transition-[transform,background-color,border-color] duration-200 hover:border-[rgba(254,252,232,0.22)] hover:bg-(--color-forest-800)'
              >

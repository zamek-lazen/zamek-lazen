      ...
      <div className="mx-auto w-full max-w-[94rem]">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-end">
          <div className="max-w-[34rem]">
            ...
            <Link
              href="/galerie"
              className="mt-8 inline-flex min-h-11 items-center justify-center border border-[rgba(19,52,45,0.16)] bg-[rgba(255,255,255,0.48)] px-6 py-3 font-sans text-[0.75rem] uppercase tracking-[0.18em] transition-colors duration-200 hover:bg-white"
            >
              {cta}
            </Link>
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
            <div
              className="group relative min-h-[25rem] overflow-hidden rounded-[1rem]"
            >
              <Image
            ...
            <div className="grid gap-3">
              <div
                className="group relative min-h-[12rem] overflow-hidden rounded-[0.9rem]"
              >
                <Image

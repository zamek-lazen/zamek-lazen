          ...
          <div className="mt-[0.2rem] grid border-t border-[rgba(178,201,190,0.22)]">
            {spotlightLinks.map((link, index) => (
              <Link
                key={link.href}
                href={link.href}
                className="grid gap-[0.3rem] border-b border-[rgba(178,201,190,0.18)] py-4 transition-[opacity,transform] duration-200 hover:translate-x-1 hover:opacity-100 md:grid-cols-[auto_minmax(0,0.7fr)_minmax(0,1fr)] md:gap-4 md:items-start"
              >

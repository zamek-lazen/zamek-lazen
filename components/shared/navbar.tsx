...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[94rem] px-3 pb-2 pt-3 md:px-8 md:pb-3 md:pt-4">
              ...
              return (
                <Link
                  ...
                  className={`border-b border-transparent pb-1 transition ${
                    isActive
                      ? "border-mist-100 text-mist-50 font-bold"
        ...
        <nav className="pointer-events-auto mt-2 flex items-center gap-3 overflow-x-auto pb-1 pr-6 text-[0.55rem] uppercase tracking-[0.13em] text-mist-300 [scrollbar-width:none] [-ms-overflow-style:none] md:hidden [&::-webkit-scrollbar]:hidden">
          {navItems.map((item) => {
            const isActive = pathname === item.href;
